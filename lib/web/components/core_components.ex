defmodule Web.CoreComponents do
      ...
      >
        <div class="">
          <div class="">
            ...
            >
              <div class="">
                <button phx-click={hide_modal(@on_cancel, @id)} type="button" class="" aria-label={gettext("close")}>
  ...
  def flash_group(assigns) do
    ...
    >
      Attempting to reconnect <.icon name="hero-arrow-path" class="" />
    </.flash>
    """
  end
  ...
  def input(%{type: "checkbox", value: value} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      <label class="">
        ...
        <input type="checkbox" id={@id || @name} name={@name} value="true" checked={@checked} class="" {@rest} />
        <%= @label %>
      </label>
  ...
  def table(assigns) do
    ...
    <div class="">
      <table class="">
        ...
        <tbody id={@id} phx-update={match?(%Phoenix.LiveView.LiveStream{}, @rows) && "stream"} class="">
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="">
            <td :for={{col, _i} <- Enum.with_index(@col)} phx-click={@row_click && @row_click.(row)} class="">
              <div class="">
                <span class="" />
                <span class="">
